...
It was founded in 2011 and It has influenced and mentored more than 80,000 Developers, entrepreneurs, IT professionals and gave platform to more than 300 speakers to share their skill with others.

        </p>
        <v-btn rounded depressed large class="mr-3" href="https://gdg.community.dev/gdg-jalandhar/" target="_blank" dark color="#4285F4">Join our Community</v-btn>
      </v-col>
    </v-row>
  </v-container>
</template>
